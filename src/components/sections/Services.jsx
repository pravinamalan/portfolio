...
export default function Services() {
    ...
    return (
        <section id="services" className="py-24 lg:py-32 relative overflow-hidden bg-background" data-story-section>
                            ...
                            <StaggerItem key={service.title} data-story-item>
                                <div className="paper-card p-10 h-full relative group bg-white hover:-rotate-1 transition-transform duration-500">
                                    ...
                                    <div className="flex flex-col h-full">
                                        ...
                                        <p className="font-sans text-[0.9rem] leading-relaxed text-foreground/60 italic">
                                            "{service.description}"
                                        </p>

                                        <div className="mt-auto pt-8 border-t border-dashed border-border flex justify-between items-center">
                                            <div className="mono text-[10px] font-bold text-foreground/30 uppercase tracking-widest">SERVICE_STATUS: ACTIVE</div>
